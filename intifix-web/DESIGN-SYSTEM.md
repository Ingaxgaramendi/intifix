...
--neutral-300: oklch(0.9 0.005 265); /* #D4D4D4 - Medium light */
...
--border: oklch(0.9 0.005 265); /* neutral-300 */
...
--shadow-success: 0 4px 14px 0 oklch(0.7 0.18 145 / 0.39);
--shadow-warning: 0 4px 14px 0 oklch(0.75 0.15 85 / 0.39);
--shadow-error: 0 4px 14px 0 oklch(0.6 0.2 25 / 0.39);
```
...
--color-neutral-300: oklch(0.9 0.005 265);
